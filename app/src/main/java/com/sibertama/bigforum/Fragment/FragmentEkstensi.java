 ...
 */
public class FragmentEkstensi extends Fragment {
    private View view;
    private WebView wv;
    ...
    private void checkconnection() {
        ...
        if (isInternetPresent) {
            wv.loadUrl("http://api.bigforum.co.id/ekstensi");
            onLoadNewComplete();
