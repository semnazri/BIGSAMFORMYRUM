...
public class Fragment_Form_Cuti_bawahan_view extends Fragment {
    ...
    public static Fragment_Form_Cuti_bawahan_view newInstance(String noForm) {
        Fragment_Form_Cuti_bawahan_view fragment = new Fragment_Form_Cuti_bawahan_view();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_cuti_bawahan_form_view, container, false);
