 ...
 */
public class PerwakilanFragment extends Fragment {
    private View view;
    private TextView title,title1,title2,title3,title4,title5,title6,title7,title8,title9,title10;
    private TextView desc1,desc2,desc3,desc4,desc5,desc6,desc7,desc8,desc9,desc10;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.perwakilan_layout, container, false);
